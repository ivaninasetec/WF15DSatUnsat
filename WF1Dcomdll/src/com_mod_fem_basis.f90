	!********************************************************************************************************************
	! TITLE         : COM_MOD_FEM_BASIS: BASIS FUNCTIONS AND INTERPOLATION USING BASIS FUNCTIONS
	! PROJECT       : WF1DCOMDLL
	...
	!--------------------------------------------------------------------------------------------------------------------
	! F: dinterpolate_with_basis(x,nodevalues,xpoints)
	!--------------------------------------------------------------------------------------------------------------------
	!> @brief
	!> Interpolate at coord \b x given the values on nodes (\b nodevalues) and coords of nodes (\b xpoints), unsing basis
	!> functions and return the derivative at the point.
	!>
